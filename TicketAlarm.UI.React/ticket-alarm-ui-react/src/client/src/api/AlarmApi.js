...
export default class AlarmApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the apiAlarmsGet operation.
     * @callback module:api/AlarmApi~apiAlarmsGetCallback
     ...
     * @param {Number} [idShow] 
     * @param {module:api/AlarmApi~apiAlarmsGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ShowDto>}
     */
    apiAlarmsGet(opts, callback) {
      opts = opts || {};
      let postBody = null;
